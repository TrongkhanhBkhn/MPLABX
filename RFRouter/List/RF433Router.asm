...
; 0000 008A // Func7=In Func6=In Func5=Out Func4=In Func3=Out Func2=Out Func1=In Func0=In
; 0000 008B // State7=T State6=T State5=0 State4=T State3=0 State2=0 State1=T State0=T
...
; 0000 0090 // Func6=In Func5=In Func4=In Func3=In Func2=In Func1=In Func0=In
; 0000 0091 // State6=T State5=T State4=T State3=T State2=T State1=T State0=T
...
; 0000 00A3 // Clock value: 125.000 kHz
; 0000 00A4 // Mode: Normal top=0xFFFF
; 0000 00A5 // OC1A output: Discon.
; 0000 00A6 // OC1B output: Discon.
; 0000 00A7 // Noise Canceler: On
; 0000 00A8 // Input Capture on Rising Edge
...
; 0000 00CD // USART Transmitter: Off
; 0000 00CE // USART Mode: Asynchronous
; 0000 00CF // USART Baud Rate: 9600
; 0000 00D0 UCSRA=0x00;
	LDI  R30,LOW(0)
	OUT  0xB,R30
; 0000 00D1 UCSRB=0x90;
	LDI  R30,LOW(144)
	OUT  0xA,R30
; 0000 00D2 UCSRC=0x86;
	LDI  R30,LOW(134)
	OUT  0x20,R30
; 0000 00D3 UBRRH=0x00;
	LDI  R30,LOW(0)
	OUT  0x20,R30
; 0000 00D4 UBRRL=0x33;
	LDI  R30,LOW(51)
	OUT  0x9,R30
; 0000 00D5 
...
; 0000 00DE ADCSRA=0x00;
	OUT  0x6,R30
; 0000 00DF 
; 0000 00E0 // SPI initialization
; 0000 00E1 // SPI Type: Master
