...
${OBJECTDIR}/Firmware/Console.o: Firmware/Console.c  nbproject/Makefile-${CND_CONF}.mk
	...
	${MP_CC} $(MP_EXTRA_CC_PRE) -D__DEBUG -D__MPLAB_DEBUGGER_ICD3=1 -p$(MP_PROCESSOR_OPTION) -I"C:/microchip_solutions_v2013-06-15/Microchip/Include" -I"C:/microchip_solutions_v2013-06-15/Microchip/USB" -I"." -ms -oa-  -I ${MP_CC_DIR}\\..\\h  -fo ${OBJECTDIR}/Firmware/Console.o   Firmware/Console.c 
...
${OBJECTDIR}/Firmware/main.o: Firmware/main.c  nbproject/Makefile-${CND_CONF}.mk
	...
	${MP_CC} $(MP_EXTRA_CC_PRE) -D__DEBUG -D__MPLAB_DEBUGGER_ICD3=1 -p$(MP_PROCESSOR_OPTION) -I"C:/microchip_solutions_v2013-06-15/Microchip/Include" -I"C:/microchip_solutions_v2013-06-15/Microchip/USB" -I"." -ms -oa-  -I ${MP_CC_DIR}\\..\\h  -fo ${OBJECTDIR}/Firmware/main.o   Firmware/main.c 
...
${OBJECTDIR}/Firmware/Console.o: Firmware/Console.c  nbproject/Makefile-${CND_CONF}.mk
	...
	@${RM} ${OBJECTDIR}/Firmware/Console.o.d 
	@${RM} ${OBJECTDIR}/Firmware/Console.o 
	${MP_CC} $(MP_EXTRA_CC_PRE) -p$(MP_PROCESSOR_OPTION) -I"C:/microchip_solutions_v2013-06-15/Microchip/Include" -I"C:/microchip_solutions_v2013-06-15/Microchip/USB" -I"." -ms -oa-  -I ${MP_CC_DIR}\\..\\h  -fo ${OBJECTDIR}/Firmware/Console.o   Firmware/Console.c 
	@${DEP_GEN} -d ${OBJECTDIR}/Firmware/Console.o 
	@${FIXDEPS} "${OBJECTDIR}/Firmware/Console.o.d" $(SILENT) -rsi ${MP_CC_DIR}../ -c18 
...
${OBJECTDIR}/Firmware/main.o: Firmware/main.c  nbproject/Makefile-${CND_CONF}.mk
	...
	@${RM} ${OBJECTDIR}/Firmware/main.o.d 
	@${RM} ${OBJECTDIR}/Firmware/main.o 
	${MP_CC} $(MP_EXTRA_CC_PRE) -p$(MP_PROCESSOR_OPTION) -I"C:/microchip_solutions_v2013-06-15/Microchip/Include" -I"C:/microchip_solutions_v2013-06-15/Microchip/USB" -I"." -ms -oa-  -I ${MP_CC_DIR}\\..\\h  -fo ${OBJECTDIR}/Firmware/main.o   Firmware/main.c 
	@${DEP_GEN} -d ${OBJECTDIR}/Firmware/main.o 
	@${FIXDEPS} "${OBJECTDIR}/Firmware/main.o.d" $(SILENT) -rsi ${MP_CC_DIR}../ -c18 
